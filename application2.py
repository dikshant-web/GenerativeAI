...
# Sidebar (History)
st.sidebar.title("KALE DHANDO KI History")
...
if st.session_state.history:
    ...
    st.sidebar.write("KOI PAAP NAHI KIYA")

# Clear history button
if st.sidebar.button("PAAP DHOLO"):
    st.session_state.history = []

# Main UI
st.title("Dikshant AI")
st.write("HAR GHAR AI YOJANA")
